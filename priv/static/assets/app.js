        ...
        if (data.validation === "correct" || !data.validation) {
          ...
          Array.from(inputCells).forEach((inputCell, index) => {
            setTimeout(() => {
              ...
              const updatedBackground = getBackgroundClass2(inputCell, data.solution, index);
              setTimeout(() => {
