...
`, template.innerHTML.trim());
  ...
  // js/hooks/invalid_text_animation.js
  var invalid_text_animation_default = {
    mounted() {
  ...
  var Hooks2 = {
    invalidTextAnimation: invalid_text_animation_default,
