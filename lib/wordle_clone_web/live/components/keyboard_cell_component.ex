defmodule WordleCloneWeb.KeyboardCellComponent do
  ...
  def render(%{keycap_value: "backspace"} = assigns) do
    ...
    <kbd
      id={@id}
      class="kbd kbd-lg text-slate-100 cursor-default rounded-md border-transparent bg-keyboard"
      phx-click="keydown"
  ...
  def render(%{keycap_value: "enter"} = assigns) do
    ...
    <kbd
      id={@id}
      class="kbd kbd-lg text-slate-100 cursor-default font-bold border-transparent rounded-md py-3 text-xs bg-keyboard"
      phx-click="keydown"
      phx-value-key="Enter"
    >
